...
mod tests {
    ...
    mod part1 {
        ...
        test!(example, file env!("YEAR2017_DAY12_EX"), "6", part1);
        test!(actual, file env!("YEAR2017_DAY12"), "141", part1);
    }

    mod part2 {
        use super::*;

        test!(example, file env!("YEAR2017_DAY12_EX"), "2", part2);
        test!(actual, file env!("YEAR2017_DAY12"), "171", part2);
    }
}
