...
mod tests {
    ...
    mod part1 {
        ...
        test!(
            example,
            file env!("YEAR2018_DAY10_EX_IN"),
            file env!("YEAR2018_DAY10_EX_OUT"),
            part1
        );
        test!(
            actual,
            file env!("YEAR2018_DAY10"),
            file env!("YEAR2018_DAY10_ACTUAL_OUT"),
            part1
        );
    }
    ...
    mod part2 {
        ...
        test!(example, file env!("YEAR2018_DAY10_EX_IN"), "3", part2);
        test!(
            actual,
            file env!("YEAR2018_DAY10"),
            "10355",
