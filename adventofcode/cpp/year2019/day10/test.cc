...
TEST(Year2019Day10, Part1Example1) {
  std::ifstream input("adventofcode/cpp/year2019/day10/testdata/ex1");
  std::string output = "8";
...
TEST(Year2019Day10, Part1Example2) {
  std::ifstream input("adventofcode/cpp/year2019/day10/testdata/ex2");
...
TEST(Year2019Day10, Part1Example3) {
  std::ifstream input("adventofcode/cpp/year2019/day10/testdata/ex3");
...
TEST(Year2019Day10, Part1Example4) {
  std::ifstream input("adventofcode/cpp/year2019/day10/testdata/ex4");
...
TEST(Year2019Day10, Part1Example5) {
  std::ifstream input("adventofcode/cpp/year2019/day10/testdata/ex5");
...
TEST(Year2019Day10, Part1Actual) {
  std::ifstream input("adventofcode/inputs/2019/10");
