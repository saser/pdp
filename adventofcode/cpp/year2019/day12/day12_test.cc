...
TEST(Year2019Day12, Part1Example1) {
  std::ifstream input("adventofcode/cpp/year2019/day12/testdata/ex1");
...
TEST(Year2019Day12, Part1Example2) {
  std::ifstream input("adventofcode/cpp/year2019/day12/testdata/ex2");
...
TEST(Year2019Day12, Part1Actual) {
  std::ifstream input("adventofcode/data/year2019/day12/actual.in");
