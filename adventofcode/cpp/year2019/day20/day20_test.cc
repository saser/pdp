#include "adventofcode/cpp/year2019/day20/day20.h"
...
TEST(Year2019Day20, Part1Example1) {
  std::ifstream input("adventofcode/cpp/year2019/day20/testdata/p1ex1");
...
TEST(Year2019Day20, Part1Example2) {
  std::ifstream input("adventofcode/cpp/year2019/day20/testdata/p1ex2");
...
TEST(Year2019Day20, Part1Actual) {
  std::ifstream input("adventofcode/data/year2019/day20/actual.in");
...
TEST(Year2019Day20, Part2Example1) {
  std::ifstream input("adventofcode/cpp/year2019/day20/testdata/p2ex1");
