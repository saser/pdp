...
TEST(Year2019Day03, Part1Example1) {
  std::ifstream input("adventofcode/cpp/year2019/day03/testdata/example1");
  std::string output = "6";
...
TEST(Year2019Day03, Part1Example2) {
  std::ifstream input("adventofcode/cpp/year2019/day03/testdata/example2");
...
TEST(Year2019Day03, Part1Example3) {
  std::ifstream input("adventofcode/cpp/year2019/day03/testdata/example3");
...
TEST(Year2019Day03, Part1Actual) {
  std::ifstream input("adventofcode/inputs/2019/03");
