#include "adventofcode/cpp/year2019/day06/day06.h"
...
TEST(Year2019Day06, Part1Example) {
  std::ifstream input("adventofcode/cpp/year2019/day06/testdata/p1ex");
...
TEST(Year2019Day06, Part2Example) {
  std::ifstream input("adventofcode/cpp/year2019/day06/testdata/p2ex");
  std::string output = "4";
